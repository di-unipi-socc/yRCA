...
if __name__ == "__main__":
    # output CSV files
    accuracyCSV = "accuracy.csv"
    accuracy = open(accuracyCSV,"w")
    timeCSV = "time.csv"
    timeFile = open(timeCSV,"w")
    ...
    for subfolder in subfolders:
        ...
        accuracy.write(subfolder + "\n")
        timeFile.write(subfolder + "\n")

        # process each log file, separately
        for file in logFiles:
            print("*"*5 + file + "*"*5)
            # create csv strings for outputs
            accuracy.write(file)
            timeFile.write(file)
