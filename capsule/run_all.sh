...
python3 yrca.py data/examples/sock-echo/orders-fail/event-orders.log data/examples/sock-echo/orders-fail/all.log data/templates/chaos-echo.yml
echo ""
echo -e "${C}* Case 1.2: Failure observed on 'frontend'${NC}"
python3 yrca.py data/examples/sock-echo/orders-fail/event-frontend.log data/examples/sock-echo/orders-fail/all.log data/templates/chaos-echo.yml
echo ""
echo -e "${C}* Case 1.3: Failure observed on 'edgeRouter'${NC}"
python3 yrca.py data/examples/sock-echo/orders-fail/event-edgeRouter.log data/examples/sock-echo/orders-fail/all.log data/templates/chaos-echo.yml
...
python3 yrca.py data/examples/sock-echo/users-shipping-fail/event.log data/examples/sock-echo/users-shipping-fail/all.log data/templates/chaos-echo.yml
